...
import 'package:ktest/src/presentation/bloc/main_bloc.dart';
...
import 'package:ktest/src/presentation/ui/details_screen.dart';
...
class CharactersScreen extends StatelessWidget {
  ...
  Widget _successfulWidget(BuildContext context, SuccessfulMainPageState state) {
    return ListView.builder(
      cacheExtent: state.characters.length.toDouble(),
